export default function VerifyErroCode(errorCode) {
    switch (errorCode) {
        ...
        case 'auth/wrong-password':
            return 'A senha informada não corresponde ao email cadastrado, por favor tente novamente ou entre em contato com alguém do suporte para redefinir sua senha!.';
